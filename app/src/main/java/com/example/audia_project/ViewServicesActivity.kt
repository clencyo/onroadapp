...
class ViewServicesActivity : AppCompatActivity() {
    ...
    private val doctor_details1 = arrayOf(
        ...
        arrayOf(
            ...
            "Hospital address : Eldoret",
            "Exp : 4years",
            "Mobile No:0714550110",
            "500"
        ),
        arrayOf(
            "Doctor Name : Ellah Danniela",
            "Hospital address : Chiromo",
            "Exp : 10years",
            "Mobile No:0716550124",
            "700"
        ),
        arrayOf(
            "Doctor Name : Diana Chemtkaa",
